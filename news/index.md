...
- The helper functions
  [`survival_time_coxnet()`](https://censored.tidymodels.org/reference/survival_time_coxnet.md)
  and
  [`survival_prob_coxnet()`](https://censored.tidymodels.org/reference/survival_prob_coxnet.md)
